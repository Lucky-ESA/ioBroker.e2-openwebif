        ...
        try {
                ...
                if (
                    ...
                    if (
                        ...
                        try {
                            ...
                            this.checkTypes[path] = types;
                            this.adapter.log.info(obj_state.common.type + " Change " + types + " - " + path);
                        } catch (error) {
            ...
            for (const key of objectKeys) {
                ...
                if (Array.isArray(element[key])) {
                    ...
                    //only e2-openwebif
                    if (
                        (this.checkValues[path_key] !== null &&
                        ...
                        if (
                            ...
                            try {
                                ...
                                this.checkTypes[path_key] = type;
                                this.adapter.log.info(obj_state.common.type + " Change " + type + " - " + path_key);
                            } catch (error) {
                                this.adapter.log.error("Error change types: " + path + " " + JSON.stringify(element));
                                this.adapter.log.error(error);
                            }
        ...
        try {
            ...
            for (let index in element) {
                ...
                if (
                    ...
                    if (
                        (this.checkValues[key_subkey] !== null &&
                        ...
                        if (
                            ...
                            try {
                                ...
                                this.checkTypes[key_subkey] = types;
                                this.adapter.log.info(obj_state.common.type + " Change " + types + " - " + key_subkey);
                            } catch (error) {
                                this.adapter.log.error("Error change types: " + key_subkey + " " + JSON.stringify(subValue));
                                this.adapter.log.error(error);
                            }
                        }
